...
all_results = {
    ...
    "titles": titles,
    "statuses": statuses,
    "subject_tags_list": subject_tags,
    ...
    "all_tags": all_tags,
    "km_cluster_names": convert_keys(km_cluster_names),
    "hier_cluster_names": convert_keys(hier_cluster_names),
    "hdb_cluster_names": convert_keys(hdb_cluster_names),
